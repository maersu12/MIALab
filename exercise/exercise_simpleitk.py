...
def register_images(img, label_img, atlas_img):
    ...
    registered_label = sitk.Resample(label_img,
                                     ...
                                     defaultPixelValue=0.0)  # todo: modify here
...
def preprocess_rescale_numpy(np_img, new_min_val, new_max_val):
    ...
    # see https://stackoverflow.com/questions/1735025/how-to-normalize-a-numpy-array-to-within-a-certain-range
...
def extract_feature_median(img):
    ...
    filter = sitk.MedianImageFilter()  # todo: modify here
    median_img = filter.Execute(img)
    return median_img
...
def postprocess_largest_component(label_img):
    ...
    connected_components =components.Execute(label_img)
